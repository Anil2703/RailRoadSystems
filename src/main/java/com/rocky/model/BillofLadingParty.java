...
public class BillofLadingParty {
    ...
    // Constructor
    public BillofLadingParty() {
    }

    public BillofLadingParty(String partyName, String partyAddress, String partyCity, String partyStateCode, String partyZipCode, String partyCountry, String partyPhoneNumber, String partyEmail, String partyTaxId, String partyContactPerson) {
        this.partyName = partyName;
        this.partyAddress = partyAddress;
        this.partyCity = partyCity;
        this.partyStateCode = partyStateCode;
